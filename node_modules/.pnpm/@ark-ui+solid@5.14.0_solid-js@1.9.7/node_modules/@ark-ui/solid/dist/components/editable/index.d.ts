...
interface UseEditableProps extends Optional<Omit<editable$1.Props, 'dir' | 'getRootNode'>, 'id'> {
}
interface UseEditableReturn extends Accessor<editable$1.Api<PropTypes>> {
}
declare const useEditable: (props?: MaybeAccessor<UseEditableProps>) => Accessor<editable$1.Api<PropTypes>>;
