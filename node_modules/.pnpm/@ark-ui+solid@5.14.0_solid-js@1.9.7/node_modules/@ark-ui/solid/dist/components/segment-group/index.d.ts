...
interface UseSegmentGroupProps extends Optional<Omit<radio.Props, 'dir' | 'getRootNode'>, 'id'> {
}
...
declare const segmentGroupAnatomy: _zag_js_anatomy.Anatomy<"label" | "root" | "item" | "indicator" | "itemControl" | "itemText">;
